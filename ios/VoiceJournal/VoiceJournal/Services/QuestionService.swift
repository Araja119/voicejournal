...
class QuestionService {
    ...
    // MARK: - Get AI Suggested Questions
    func getSuggestedQuestions(journalId: String, count: Int = 3) async throws -> [SuggestedQuestion] {
        let response: SuggestedQuestionsResponse = try await client.request(.suggestedQuestions(journalId: journalId))
